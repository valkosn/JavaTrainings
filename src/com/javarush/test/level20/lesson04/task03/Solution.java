...
public class Solution implements Serializable {
    ...
    //Recreating the instance AGAIN by reading the serialized object data store
        ObjectInputStream ois3 = new ObjectInputStream(new FileInputStream("singleton.tmp"));
        Singleton singleton2 = (Singleton) ois3.readObject();
        ois3.close();

    //Recreating the instance AGAIN by reading the serialized object data store
        ObjectInputStream ois4 = new ObjectInputStream(new FileInputStream("singleton.tmp"));
        Singleton singleton3 = (Singleton) ois4.readObject();
        ois4.close();
        ...
        System.out.println("Instance reference check : " + singleton2.getInstance());
        System.out.println("Instance reference check : " + singleton3.getInstance());
        System.out.println("=========================================================");
        System.out.println("Object reference check : " + singleton);
        System.out.println("Object reference check : " + singleton1);
        System.out.println("Object reference check : " + singleton2);
        System.out.println("Object reference check : " + singleton3);
    }
