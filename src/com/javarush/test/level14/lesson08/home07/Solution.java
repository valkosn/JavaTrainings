...
public class Solution
{
    ...
    {
        for (Apartament ttt : apartaments)
        {
            String className = ttt.getClass().getSimpleName();

            switch (className)
            {
                case "Apt1Room": ((Apt1Room)ttt).clean1Room();
                    break;
                case "Apt2Room": ((Apt2Room)ttt).clean2Rooms();
                    break;
                case "Apt3Room": ((Apt3Room)ttt).clean3Rooms();
                    break;
            }
