...
public class Solution {
    public static void main(String[] args) {
        ...
        new Tree().info(new Integer("4").getClass().getSuperclass());
        new Tree().info(new Short("4").getClass().getSuperclass());
        new Tree().info(new BigDecimal("4").getClass().getSuperclass());
